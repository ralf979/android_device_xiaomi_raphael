...
Return<bool> FingerprintInscreen::handleAcquired(__unused int32_t acquiredInfo, __unused int32_t vendorCode) {
    return false;
}

Return<bool> FingerprintInscreen::handleError(__unused int32_t error, __unused int32_t vendorCode) {
    return false;
}
